package cl.tickers.app.ui.about
            ...
            LazyColumn(
                ...
                item {
                    AppCard {
                        ...
                        Text(
                            "Tickers es una aplicación independiente. No está afiliada, " +
                ...
                item {
                    AppCard {
                        ...
                        Text(
                            "Tickers ${BuildConfig.VERSION_NAME}",
                            style = MaterialTheme.typography.bodyMedium,
                        )
                        Spacer(Modifier.height(4.dp))
                        LinkRow("Código fuente y licencia MIT", "https://github.com/ellokojavi/Tickers") {
                            uris.openUri(it)
                        }
                    }
                }
