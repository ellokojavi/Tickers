...
import cl.ufchile.app.data.local.dao.SimulationDao
import cl.ufchile.app.data.local.dao.UfDao
import cl.ufchile.app.data.local.entity.IndicatorEntity
import cl.ufchile.app.data.local.entity.SimulationEntity
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        fun build(context: Context): AppDatabase =
            Room.databaseBuilder(context, AppDatabase::class.java, "ufchile.db")
                .build()
    }
}
